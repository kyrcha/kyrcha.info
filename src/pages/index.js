    ...
    <div>
      ...
      <div className="section">
        <div className="content">
          <p>
            My name is Kyriakos Chatzidimitriou. Since I prefer my work to talk
            about who I am, I will just say that my background is Software
            Engineering (programmer, architect, team manager) and Machine
            Learning (PhD and as a researcher) and so are my research,
            development and business interests. At the moment my main interests
            are:
          </p>
          <ul>
            <li>
            ...
            <li>
              Looking for my next startup gig after two failures (one founded,
              one joined)
            </li>
            <li>Learning DeFi</li>
            <li>
              Writing programming, machine learning and blockchain/DeFi books
              and posts, producing courses on the subjects
            </li>
            <li>Learning how to draw</li>
            <li>Getting from fat to savage</li>
            <li>
              Learning STEM stuff and robotics to my kids and produce content
              around it
            </li>
            <li>
              Learn and get better in online selling and marketing (so please
              bare some affiliate links :)).
            </li>
        ...
        <ul>
          ...
          <p>
            As a developer (and for the time being as these things change), I am
            fond of the MERN stack (MongoDB, Expressjs, React.js, Node.js) for
            building web applications, React Native for building mobile apps but
            I also work with Angular, NestJS, C#, Go, Python and R in projects.
          </p>
          ...
          <ul>
            ...
            <ul>
              <li>
                <Link to="/about/me">Me</Link>: information about me, including
                my CV and my social media profiles.
              </li>
              <li>
                <Link to="/about/timeline">Timeline</Link>: my personal
                timeline.
              </li>
            </ul>
            <li>
              <Link to="/blog">Blog</Link>: my blog on personal, research and
              development activities, tutorials and 'how tos', personal
              opinions, book reviews, exercise and nutrition posts etc.
            </li>
            <li>
              <Link to="/bits">Bits</Link>: where I list short snippets of code
              and knowledge in various domains.
            </li>
            <li>
              <Link to="/notes">Notes</Link>: links to notes I keep on various
              subjects.
            </li>
            <li>
              <Link to="/external">External</Link>: links to pieces that I
              created and exist on external platforms like medium, twitter,
              substack etc.
            </li>
            <li>
              <Link to="/research">Research</Link>: my portfolio of research
              projects that includes areas of research and funded projects I
              worked or I am working on.
            </li>
            <li>
              <Link to="/development">Development</Link>: my portfolio of
              development projects that includes open source software, libraries
              and tools I am involved in (as a developer or as a manager/team
              leader), as well as any running applications web or mobile.
            </li>
            <li>
              <Link to="/publications">Publications</Link>: my publish or perish
              statistics profile and my publications list.
            </li>
            <li>
              Resources: Pages that provide links to the best things (articles,
              videos, books, podcasts etc.) I found on the web on specific
              subjects along with my narration and links to my posts. I got this
              idea from{" "}
              <OutboundLink href="http://martinfowler.com/">
                Martin Fowler
              </OutboundLink>
              's Resource Guides, as for example that on{" "}
              <OutboundLink href="http://martinfowler.com/microservices/">
                Microservices
              </OutboundLink>
              .
            </li>
